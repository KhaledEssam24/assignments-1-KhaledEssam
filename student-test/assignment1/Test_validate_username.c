 ...
 *   1) Call the my_username() function in Test_assignment_validate.c to get
 * your hard coded username. 2) Obtain the value returned from function
 ...
 * unity assertion TEST_ASSERT_EQUAL_STRING_MESSAGE the two strings are equal.
 * See the [unity assertion
...
void test_validate_my_username() {
   ...
   * setup properly
   */
  TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(),
                                   malloc_username_from_conf_file(), "FAILED");
}
